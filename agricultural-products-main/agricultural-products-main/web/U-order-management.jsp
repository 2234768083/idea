...
<div class="main">
	...
	<!--  <img src="product/P1.png"/>-->
		<table>
		<tr>
			<th class="th1">订单简要</th>
			<th class="th2">附加信息</th>
		</tr>
		<%
			CachedRowSetImpl rowSet=dataBeanlongin.getRowSetUorder();
		
			//rowSet.beforeFirst();//将光标定位到结果集中第一行之前。
			while(rowSet.next()){//next();滚动参考resultset的方法
				out.print("<tr>");
				out.print("<td class='td-img'>");
				out.print("<p>订单编号:"+rowSet.getString(1)+"</p>");
				out.print("<p>产品识别码:"+rowSet.getString(2)+"</p>");
				out.print("<p>下单用户:"+rowSet.getString(3)+"</p>");
				//out.print("<img src='"+"product/"+rowSet.getString(2)+"'>");
				out.print("</td>");
				//out.print("<td>"+rowSet.getString(2)+"</td>");
				out.print("<td class='td-show'>");
				out.print("<p>收货人:"+rowSet.getString(4)+"</p>");
				out.print("<p>收货人手机号:"+rowSet.getString(6)+"</p>");
				out.print("<p>收货地址:"+rowSet.getString(5)+"</p>");
				out.print("<p>留言:"+rowSet.getString(7)+"</p>");
				//out.print("<p class='td-show-number'>单价:"+rowSet.getString(6)+"元/斤</p>");
				//out.print("<p class='td-show-number'>起批量:"+rowSet.getString(7)+"斤</p>");
				out.print("</td>");
