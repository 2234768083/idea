 ...
 */
@WebServlet("/UDemandMangementServlet")
public class UDemandMangementServlet extends HttpServlet {
     ...
     */
    public UDemandMangementServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		// TODO Auto-generated method stub
				...
				try {
					String condition="Select * from demand where  Unum='"+dataBean.getlogname()+"'";
					...
					rowSet.populate(rs);
					dataBean.setRowSetUDemand(rowSet);;//行集数据存储到dataBean
					
					con.close();//关闭连接
					}catch(SQLException e) {    
				}
				response.sendRedirect("U-demand-management.jsp");
