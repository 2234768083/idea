...
public class BookDataSet {
    ...
    static {
        ...
        books.add(new Book("b0001", "Java核心技术", "霍斯特曼", 50, categories.get(1)));
        books.add(new Book("b0002", "名著-三国演义", "罗贯中", 40, categories.get(2)));
        books.add(new Book("b0003", "名著-水浒传", "施耐庵", 30, categories.get(2)));
        books.add(new Book("b0004", "名著-红楼梦", "曹雪芹", 20, categories.get(2)));
        setBooks();
    }
