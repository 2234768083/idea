...
<html>
  <head>
	...
	<body>
		<form name="fom" id="fom" method="post" action="servlet/AdminServlet?method=stuRegister">
										...
										<fieldset style="height:100%;">
											...
											<table border="0" cellpadding="2" cellspacing="1" style="width:100%">
												...
												<tr>
													<td>学生名称:</td>
													<td>
														<input name="sname" type="text" class="text" style="width:154px" value="" />${msg }
													</td>
												</tr>
												...
												<tr>
													<td>出生日期:</td>
													<td>
														<input class="text" name='birth' style="width:154px" value=""  onfocus="WdatePicker()"/>
													</td>
												</tr>
												<tr>
													<td>班级:</td>
												...
												<tr>
													<td valign="top">描述:</td>
													<td colspan="3">
														<textarea name="remark" cols="100" rows="8" id="re"></textarea>
													</td>
												</tr>
											</table>
											<br />
