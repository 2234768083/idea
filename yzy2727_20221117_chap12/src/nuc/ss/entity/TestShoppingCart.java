...
public class TestShoppingCart {
	...
	public static void main(String[] args) {
		...
		//电商平台可买的书籍
		System.out.println("库存不足!这本编号为b00001,书名为数据结构与算法的书仅剩2本，请修改购买数量！！！");
		Book b1 = new Book("b00001", "数据结构", "严蔚敏", 45.6f, 20,new Category(1,"软件开发","算法"));
		...
		//为用户创建一辆购物车
		User u = new User("u00001","殷子岳","123456","管理员",'男',"太原");
